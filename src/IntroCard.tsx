  ...
  return (
    <div className='title-card'>
      ...
      <p className='quiz-info'>
        You have 1 hour to discover the code and find the key! Let's see if Akhil's Family & Friends have what it takes! Type the answers to the questions in the boxes. If you type
